...
const InventoryFields: React.FC = () => {
  ...
  const { values, handleChange, setFieldValue } = useFormikContext<InventoryForm>()
  ...
  useEffect(() => {
    ...
    {/* Name Field */}
    <div>
        <label htmlFor="name" className="block text-gray-900 text-sm font-medium">
        Name
        </label>
        <Field
        id="name"
    ...
    {/* Category Field */}
    <div>
        <label htmlFor="category" className="block text-sm text-gray-900 font-medium">
        Category
        </label>
        <Field
        id="category"
    ...
    {/* Value Field */}
    <div>
        <label htmlFor="value" className="block text-sm text-gray-900 font-medium">
    ...
    {/* Quantity Field */}
    <div>
        <label htmlFor="quantity" className="block text-sm text-gray-900 font-medium">
        Quantity
        </label>
        <Field
        id="quantity"
    ...
    {/* Price Field */}
    <div>
        <label htmlFor="price" className="block text-sm text-gray-900 font-medium">
        Price
        </label>
        <Field
        id="price"
